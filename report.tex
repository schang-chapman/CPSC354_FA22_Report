...
\medskip\noindent
seqRec can be treated as the second prototype on account of it building off knowledge I had already learned from class. In doing this, I was able to map out the logic of the functions from a familiar approach before tackling them in new ways.
...
\subsubsection{Haskell zipWith Function}
Test

\subsubsection{Haskell scanl Function}
Test

\subsubsection{Manipulating Lists}
Test

\subsection{Critical Appraisal}
There are no known bugs in my final project.
